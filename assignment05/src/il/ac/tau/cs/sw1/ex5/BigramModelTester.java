...
public class BigramModelTester {
	...
	public static final String RAP_GOD_FILENAME = "resources/hw5/rap_god.txt";
	public static final String RAP_GOD_MODEL_DIR = "resources/hw5/rap_god_model";
	

	public static void main(String[] args) throws IOException{
		BigramModel sG = new BigramModel();
		BigramModel emineM = new BigramModel();
		
		
		String[] voc = sG.buildVocabularyIndex(ALL_YOU_NEED_FILENAME);
		String[] vocRapGod = emineM.buildVocabularyIndex(RAP_GOD_FILENAME);
		emineM.initModel(RAP_GOD_FILENAME);
		emineM.saveModel(RAP_GOD_MODEL_DIR);
